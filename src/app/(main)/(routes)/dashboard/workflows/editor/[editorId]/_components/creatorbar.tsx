...
import RenderConnectionAccordion from "./render-connection";
import RenderOutputAccordion from "./render-output";
...
const Creatorbar = ({ nodes }: Props) => {
  const { state } = useEditor();
  const { nodeConnection } = useNodeConnections();
  const { googleFile, setSlackChannels } = useSyncStore();
  useEffect(() => {
    if (state) {
